# base image
FROM python:3.8.12
LABEL org.opencontainers.image.source https://github.com/tejaswitadelu/MyFaceAI

# -----------------------------------
# create required folder
RUN mkdir -p /app && chown -R 1001:0 /app
RUN mkdir /app/MyFaceAI
